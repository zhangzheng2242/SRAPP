...
#libtorch配置
#include("D:\Qt\libtorch-win-shared-with-deps-1.11.0+cpu\libtorch\libtorch.pri")

INCLUDEPATH += D:\Qt\libtorch-win-shared-with-deps-1.7.0+cpu\libtorch\include
INCLUDEPATH += D:\Qt\libtorch-win-shared-with-deps-1.7.0+cpu\libtorch\include\torch\csrc\api\include
INCLUDEPATH += D:\Qt\libtorch-win-shared-with-deps-1.7.0+cpu\libtorch\include\torch\csrc\api\include\torch


LIBS += -LD:\Qt\libtorch-win-shared-with-deps-1.7.0+cpu\libtorch\lib \
        -lasmjit \
        -lc10 \
        -lclog \
        -lcpuinfo \
